...
if __name__ == "__main__":
    ...
    # }
    noise = None
    sim = CSTR('test', dt, max_index, noise)
    ...
    #     # x = A x + B u
    #     # x, u - 1-D array
    #     # sim.cur_x   #  ground truth
    #     # sim.cur_u   #  utils input of last step
    #     # sim.cur_y   #
    #     # sim.cur_feedback   # attack on this
    #
    #     sim.evolve()
    ...
    ref = [x[1] for x in sim.refs[:max_index + 1]]
    y_arr = [x[1] for x in sim.outputs[:max_index + 1]]
